...
def scrape_achievement_page(url):
    # the code asks the remote web server at the address given by the variable url.
    # The request method is GET (the standard for “give me this page”), and the call includes an HTTP header named User-Agent with value Mozilla/5. so the server sees a browser-like identifier.
